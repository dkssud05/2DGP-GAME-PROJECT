...
class Character3:
    ...
    def __init__(self):
        ...
        self.attack2_image = load_image('character3.motion/char3_Attack2.png')
        self.attack3_image = load_image('character3.motion/char3_Attack3.png')
        ...
        self.current_attack_type = 1  # 1: Attack1, 2: Attack2, 3: Attack3
        self.player_id = 1
    ...
    def get_attack_bb(self):
        ...
        if self.face_dir == 1:  # 오른쪽 공격
            left = self.x + 15
            right = self.x + 15 + attack_width
            bottom = self.y - attack_height // 2
            top = self.y + attack_height // 2
        else:  # 왼쪽 공격
            left = self.x - 15 - attack_width
            right = self.x - 15
            bottom = self.y - attack_height // 2
            top = self.y + attack_height // 2
